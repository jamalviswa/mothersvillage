...
<div class="m-grid__item m-grid__item--fluid m-wrapper">
    ...
    <div class="m-subheader ">
        <div class="d-flex align-items-center">
            ...
            <div>
                <a href="{{route('masters.flattype_index')}}" rel="tooltip" title="" class="m-portlet__nav-link btn btn-lg btn-secondary  
            ...
            <div class="col-md-12">
                <div class="m-portlet">
                    <div class="m-portlet__body">
                        <!--begin::Section-->
                        <div class="m-section">
                            <form method="post" action="{{ route('masters.flattype_store') }}" id="upload" class="validation_form" enctype="multipart/form-data">
                                @csrf
