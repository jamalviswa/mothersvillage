            ...
            <div class="col-md-12">
                <div class="m-portlet">
                    <div class="m-portlet__body">
                        <!--begin::Section-->
                        <div class="m-section">
                            <form method="post" action="{{ route('activities.store') }}" id="upload" class="validation_form" enctype="multipart/form-data">
                            @csrf
                            <div class="row">
                            <div class="col-md-6">
                                <div class="m-section__content">
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                             <textarea rows="4"  name="description"  class="form-control" autocomplete="off">{{ old('description')}}</textarea>
                                            @error('description')
                                              <span class="invalid-feedback" role="alert">
                                                 {{ $message }}
                                              </span>
                            ...
                            <div class="col-md-6">
                                 <div class="form-group row">
                                        ...
                                        <div class="col-md-8">
                                             <input value="{{ old('short_code') }}" type="text"  class="form-control" name="short_code" />
                                            @error('short_code')
                                              <span class="invalid-feedback" role="alert">
                                                 {{ $message }}
                                              </span>
