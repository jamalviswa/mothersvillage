                            ...
                            <div class="form-group row">
                                ...
                                <div class="form-group row">
                                    ...
                                    @if(!empty($detail['idproof']))
                                                <a href="{{URL::to('public/files/proof/'.$detail['idproof'].'')}}" download target="_blank" >
                                                    <img src="{{URL::to('public/files/proof/'.$detail['idproof'].'')}}" class="img-sm" style="border:1px solid #ddd"/>
                                                </a>
                                                @else
                                                -
                                                @endif
