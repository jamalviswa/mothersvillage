...
class PaymentsController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        $onbook15per = round(($data->gross_amount * 10) / 100);
        ...
        $fourth15per = round(($data->gross_amount * 10) / 100);
        ...
        $onbook20per = round(($data->gross_amount * 10) / 100);
        ...
        $third20per = round(($data->gross_amount * 10) / 100);
        ...
        $fourth20per = round(($data->gross_amount * 10) / 100);
